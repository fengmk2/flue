...
Only the options listed below are accepted. For source-module placement, see [Project Layout](/docs/guide/project-layout/). For command-line overrides and environment files, see the [CLI reference](/docs/cli/overview/).
